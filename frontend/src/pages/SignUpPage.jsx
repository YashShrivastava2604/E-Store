		...
		<div className='w-full min-h-screen flex items-center justify-center bg-gray-100 p-4'>
			<div className='relative w-full max-w-6xl h-[700px] grid grid-cols-1 md:grid-cols-2 bg-white rounded-2xl shadow-2xl overflow-hidden'>
				...
				<div className='flex flex-col justify-center p-8 sm:p-12'>
					...
					>
						<h2 className='text-3xl md:text-4xl font-extrabold text-gray-900'>Create Your Account</h2>
						<p className='mt-2 text-gray-600'>Join us and explore the future of fashion.</p>
					</motion.div>
					<motion.div
						className='mt-8'
						initial={{ opacity: 0, y: 20 }}
							...
							<div>
								...
								<div className='mt-1 relative rounded-md shadow-sm'>
									...
									<input
										...
										className='block w-full px-3 py-3 pl-10 bg-gray-50 border border-gray-300 text-gray-900 rounded-md shadow-sm
